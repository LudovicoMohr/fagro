        ...
        <div className="delivery-summary">
          <div className="delivery-order-number">
            ...
            <div className="delivery-items">
              <h5>Contagem de itens: {order.totalItemCount}</h5>
              <h5>Custo total: ${order.cost_after_delivery_rate}</h5>
              <h5>Tipo de entrega: {order.delivery_type}</h5>
              <h6>O custo total inclui a taxa de entrega</h6>
            </div>
          </div>
          <div className="delivery-progress">
            <h3 className="delivery-item-title">Completo</h3>
            <h4>
          ...
          <div className="delivery-date">
            <h3 className="delivery-item-title">Conclusão prevista</h3>
            {(order.order_processed != true &&
              order.order_cancelled != true && <h4>{formattedDate}</h4>) ||
              (order.order_processed == true && (
                <h4 className="is-delivered">Entregue</h4>
              )) ||
        ...
        >
          ...
          {order.order_processed != true && order.order_cancelled != true && (
            <div className="danger-zone">
              <h3 className="danger-zone-text">Zona Perigo</h3>
